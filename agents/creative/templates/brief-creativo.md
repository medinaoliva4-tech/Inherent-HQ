# Brief Creativo — [Cliente]
**Bloque:** [semana / quincena / mes] · **Fecha:** [fecha] · **Arquetipo:** `NN — [nombre]`
**Capa 0 · Gate humano:** ⬜ pendiente / ✅ aprobado por [nombre] el [fecha]

> Esta capa **traduce**, no decide. Ningún campo de otro departamento se reescribe: se **cita** con
> su ruta.
...
## D. Avatar — el filtro de toda idea
...
| **Dolor interno** | |
| **Deseo** | |
| **Lenguaje literal** (citas textuales) | *"..."* · *"..."* |

> **Se usa como filtro:** si una idea no le habla a este avatar, **se descarta antes de escribirla.**

## E. Slots del bloque *(copiados del calendario, sin editar)*

| slot_origen | semana | canal | funcion | pilar | temperatura | formato | frecuencia | balance | objetivo_del_slot | traza |
|---|---|---|---|---|---|---|---|---|---|---|
| | | | | | | | | | | |
...
## Huecos abiertos
- ⚠️ SIN DATOS — [qué falta, a quién pedírselo, qué confianza pierde el bloque]
- BLOQUEADO — [qué falta exactamente para desbloquear]
