...
**Qué NO es.** No es investigar la categoría — eso es la Capa 1 de Strategy y ya está hecha.
No es un moodboard. No es copiar.
...
## Paso 0 — Arrancar de lo que Strategy ya hizo

Strategy descompuso **15+ piezas ganadoras en 7 capas** (gancho, promesa, mecanismo, prueba, formato,
distribución, oferta) en `ingenieria-inversa.md` 1.3b, con sus patrones marcados 🟢/🟡/⚪.
...
🛑 **Solo se cosecha el hueco.** Repetir el barrido de categoría es duplicar el trabajo de Strategy y
llegar, con menos rigor, a otra conclusión sobre la misma categoría.

El hueco suele ser de tres tipos:
1. **Formato exacto** del slot que la 15×7 no incluyó (carrusel de 5 slides, cover de Reel)
2. **Canal exacto** que Strategy no priorizó pero el calendario sí tiene
...
|---|---|
| **Pauta** | Competidores directos del cliente + marcas grandes de la industria. Filtrar a **activos** |
| **Orgánico** | Creadores que ya tienen la audiencia (anillo 5 de Strategy) + referentes fuera de categoría (anillo 4) |
...
Los pilares son los del cliente (`estrategia-de-contenido.md` 6.2), no una lista universal.
...
```markdown
| Patrón observado | Señal ⏱️ | Fuentes (→ 🟢/🟡/⚪) | Hipótesis para nuestra marca | Pilar | Caja de hook | ¿Es default de categoría? |
```

**Reglas de traducción:**
1. Se puede modelar la **estructura**; nunca se copia la **ejecución**.
2. La hipótesis se escribe en **nuestra voz**, con el lenguaje literal del comprador de Strategy 1.5.
...
Cada patrón se cruza contra el **mapa de saturación** de Strategy:
...
> Esta verificación es la razón por la que Creative arranca de la evidencia de Strategy y no de cero:
