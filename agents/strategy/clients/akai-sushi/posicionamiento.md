# Posicionamiento — [Cliente]
**Núcleo de referencia:** `nucleo.md` · **Evidencia:** `ingenieria-inversa.md`
**Capas 2-4 · Gate humano:** ⬜ pendiente / ✅ aprobado por [nombre] el [fecha]
...
| Qué queda afuera este ciclo | Por qué |
|---|---|
| Audiencias | |
| Canales | |
| Mensajes | |
