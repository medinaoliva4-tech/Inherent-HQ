...
| | |
|---|---|
| **Qué hace** | Restaurante de sushi y cocina japonesa en Guatemala. Dos sucursales: **C.C. San Isidro, zona 16** y **Plaza Fraijanes, KM 19**. Consumo en salón + delivery propio (WhatsApp) + agregadores (PedidosYa, Uber Eats). 🟢 fuente: IG bio, captions IG, Facebook, Uber Eats |
| **Visión / ambición** | ⚠️ SIN DATOS — requiere input del cliente |
...
| **Diferenciación percibida por ellos** | *"El mejor sushi en la ciudad"* + *"calidad, precio justo"* → `[percepción del cliente, no verificado]` 🟢 fuente: caption IG feb-2026, bio IG |

### A.1 — Activos digitales detectados
| Activo | Dato | Estado |
|---|---|---|
| Instagram | `@akaisushigt_` | ✅ activo |
| Facebook | `@akaisushiz16` — "Akai Sushi GT" | ✅ activo |
| Teléfonos | Z16 `2238-0636` · Fraijanes `6633-9992` | 🟢 verificado (FB) |
| Delivery | PedidosYa, Uber Eats, WhatsApp | ✅ activo |
...
| Fecha | Vistas | Likes | Coment. | ER | Tipo de pieza |
|---|---|---|---|---|---|
| nov-2026 | 18,804 | 569 | 5 | **3.05%** | Repost de UGC de cliente ("#LoveAndSushi… nos encanta") |
| feb-2026 | 25,357 | 27 | 0 | 0.11% | Claim de marca ("el mejor sushi de la ciudad") |
| jun-2026 | 4,939 | 50 | 0 | 1.01% | Marca / emocional ("amor al primer roll") |
| mar-2026 | 6,792 | 32 | 1 | 0.49% | Marca genérica + ubicaciones |
| abr-2026 | 4,732 | 20 | 0 | 0.42% | Promo 2x1 martes/jueves |

**Observación cruda (sin recomendación):** la única pieza con engagement rate sobre 3% es un repost
de contenido de un cliente; el resto de piezas propias vive entre 0.11% y 1.01%. 🟡 señal — una sola
observación, se confirma en Capa 1.
...
**¿#1 en qué?** ⚠️ SIN DATOS

Preguntas abiertas al cliente en `_INPUTS/preguntas-capa-0.md`.

---

## C. Economía unitaria (restricción, no estrategia)

> Sin estos números la viabilidad de cualquier estrategia **no está verificada**. No se estiman.

| | Valor | Fuente |
|---|---|---|
| **Ticket promedio** | ⚠️ SIN DATOS | — |
| **Margen bruto** | ⚠️ SIN DATOS | — |
| **Capacidad de entrega** (covers/turno por sucursal) | ⚠️ SIN DATOS | — |
| **Punto de equilibrio** (covers/mes para no perder) | ⚠️ SIN DATOS | — |
| **¿Está la capacidad al tope?** | ⚠️ SIN DATOS | — |

🔴 **VIABILIDAD NO VERIFICADA.** Sin el dato de capacidad no se puede saber si el problema es
*generar más demanda* o *filtrar/monetizar mejor la que ya hay*. El 2x1 permanente de martes y jueves
sugiere que hay días valle — pero es 🟡 señal, no dato.
...
| | |
|---|---|
| **Presupuesto** | Retainer Inherent: **Q2,500/mes** (Content System, tier FOUNDING, activo desde 2026-04-21). Presupuesto de pauta: ⚠️ SIN DATOS 🟢 fuente: Inherent OS |
| **Equipo disponible** | ⚠️ SIN DATOS |
| **Capacidad de producción** (contenido) | Media vive en Jockey (`jockeyWorkspace: akai`). Producción propia in-situ: ⚠️ SIN DATOS 🟢 fuente: Inherent OS |
| **Velocidad de aprobación del cliente** | ⚠️ SIN DATOS |
| **Restricciones legales / regulatorias** | ⚠️ SIN DATOS (manejo de pescado crudo — sanitario) |
| **Prioridades declaradas** | ⚠️ SIN DATOS |
