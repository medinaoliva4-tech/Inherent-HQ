...
description: >
  ...
  idear: carga el contexto de ③ Marketing, ②B Branding y ⑧B Ads, lee los slots del calendario y convierte
  ...
  "en qué etapa juega esta pieza". Es la capa que impide que Creative reinvente lo que ③ Marketing ya
  decidió. Bloquea si falta posicionamiento aprobado o calendario.
---

# Capa 0 — Brief Creativo

Leé `agents/creative/METHOD.md` sección **CAPA 0** completa + `playbooks/TRADUCCION-DE-SLOT.md`.
...
| Archivo | De |
|---|---|
| ② posicionamiento **con Gate 2 aprobado** | ③ Marketing |
| ③ sistema de contenido | ③ Marketing |
| ③ plan por canal (función única y **qué NO se hace** por canal) | ③ Marketing |
| ③ calendario | ③ Marketing |
| ② ingeniería inversa | ③ Marketing |
| ① núcleo (arquetipo + capacidad) | ③ Marketing |
| Guidelines, tono y **lente de marca** | Branding |
| Ads que funcionan + claims aprobados *(no bloqueante)* | ⑧B Ads |
...
3. **C — Jerarquía de mensaje**: copiada tal cual de ③ Marketing §6.5. Es la ley del bloque
...
7. **G — Función y vetos por canal**: de ③ plan por canal, copiados
...
- **El `awareness` se copia con la etiqueta literal de ③ Marketing** (`Unaware`, `Problem aware`,
  `Solution aware`, `Product aware`, `Most aware`). Abreviarlo es reescribirlo.
- **La audiencia no se re-analiza.** Ya viene masticada por ③ Marketing. Se usa como filtro: si una idea
...
- **Un slot sin `traza_a_must_be_true` no se produce**: se devuelve a ③ Marketing.
- **La capacidad de producción es techo duro.** Si el calendario pide más de lo que el cliente puede
  producir, se declara y se devuelve a ③ Marketing — **no se recorta en silencio**.
